"""Document Processor Module for loading and splitting documents."""


from typing import List
from langchain_community.document_loaders import WebBasweLoader
...
class DocumentProcessor:
    ...
    def load_from_pdf_dir(self, directory: Union[str, Path])->List[Document]:
        """Load documents from all PDF's in a directory"""
    ...
    def load_documents(self,sources:List[str])->List[Document]:
        """
        Load documents from URL's, PDF Directories, and TXT files.

        Args:
            sources : List of URL's, PDF folder paths, and TXT filen paths.

            Returns:
            List of Loaded documnets      
        """
        docs: List[Document] = []
        for src in sources:
